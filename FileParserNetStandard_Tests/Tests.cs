...
namespace FileParserNetStandard_Tests {
    ...
    public class Tests {
        ...
        private string _csvPath = @"C:\Users\Muham\Desktop\Dip-Seminar-Delegates-Lambda-Linq_Exercises-master\Files"; // change to appropriate path
        private string _tsvPath = @"C:\Users\Muham\Desktop\Dip-Seminar-Delegates-Lambda-Linq_Exercises-master\Files"; // change to appropriate path

        private string _writeFile = @"C:\Users\Muham\Desktop\Dip-Seminar-Delegates-Lambda-Linq_Exercises-master\Files\dataWrite.txt";  // change to appropriate path
